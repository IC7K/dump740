    ...
    */     
        ...
        dec1_2_offs = pkkoffs;
        ok1dec1 = decodeDECADE(m, pkkoffs, pkkpulselevel, decade1_2, 0);
        ...
        ok1dec2 = decodeDECADE(m, pkkoffs, pkkpulselevel, decade1_2, 64);
        ...
        //8*8=64 periods of 0.5mks
        pkkoffs = pkkoffs + UVD_DECADE_LEN; //+64 periods by 0.5mks
        ok1dec3 = decodeDECADE(m, pkkoffs, pkkpulselevel, decade1_2, 0);
        ...
        ok1dec4 = decodeDECADE(m, pkkoffs, pkkpulselevel, decade1_2, 0);
        ...
        ok1dec5 = decodeDECADE(m, pkkoffs, pkkpulselevel, decade1_2, 0);
        ...
        ok1dec1r = decodeDECADE(m, pkkoffs, pkkpulselevel, decade1_2, 0);
        ...
        ok1dec2r = decodeDECADE(m, pkkoffs, pkkpulselevel, decade1_2, 0);
        ...
        ok1dec3r = decodeDECADE(m, pkkoffs, pkkpulselevel, decade1_2, 0);
        ...
        ok1dec4r = decodeDECADE(m, pkkoffs, pkkpulselevel, decade1_2, 0);
        ...
        ok1dec5r = decodeDECADE(m, pkkoffs, pkkpulselevel, decade1_2, 0);
        ...
        //DECODE INFO CODE - BORT NUMBER  RF- D5 D4 D3 D2 D1
            ...
            //     mediana
            //     );
            printf("\n%s - OK1 OK RKK=110 6 REGN=%c%c%c%c%c\n", timestrok1, (char) ok1dec5, (char) ok1dec4, (char) ok1dec3, (char) ok1dec2, (char) ok1dec1);
            printf("%s - OK1rOK RKK=110 6 REGN=%c%c%c%c%c\n", timestrok1, (char) ok1dec5r, (char) ok1dec4r, (char) ok1dec3r, (char) ok1dec2r, (char) ok1dec1r);
...
10:46:31.767 - Noise Lev=920  Max=1138  VResolution=113 HLen=112
          11                          11 *              11      0      111                     1111    ***      
          11                          11 *      *       11    1 0      111                     1111    ***      
          --                          -- -      -       --    - -      ---                     ----    ---      
 *       *11                          11 * *    **     111   1100      111      0              1111   1***      
 *      **11                   *      11 * *    ***    111  11100      111   11 0              1111   1***      
 *      **11                   *      11 * *    ***    111  11100      111   11 0              1111   1***      
*** * ****11   *    *  *       *      111*** ** ***   *1111 11100  0   111   11 00 0    0      1111 1 1****   **
*** ******111 ***** *  ** **** *  *   111*** ** *******11111111000 0   11111111 00000 0000 000 11111111***** ***
*** ******111 ***** *  ** **** *  *   111*** ** *******11111111000 0   11111111 00000 0000 000 11111111***** ***
*** ******111 ***** *  ** **** *  *   111*** ** *******11111111000 0   11111111 00000 0000 000 11111111***** ***
*** ******111 ***** *  ** **** *  *   111*** ** *******11111111000 0   11111111 00000 0000 000 11111111***** ***
...
10:46:31.958 - Noise Lev=920  Max=1138  VResolution=113 HLen=112
          111                         111              111             111                     11      ***      
          111                         111              1111            111                     11 1    ****     
          ---                         ---              ----            ---                     -- -    ----     
        * 111*               * *    **111              1111   1  00    1111                    1111    ****     
*       * 111*  *            * *    **111              1111   1  00    1111    0      0        1111    ****     
*       * 111*  *            * *    **111              1111   1  00    1111    0      0        1111    ****     
*  *    * 111** *   *   *   **** *  **111   *     *    1111   10 00  001111  1 0 00   0 0      1111  11**** *   
* ***** **111**** ********* **********111************* 111111 10000 0001111111100000000 0 000 011111111*********
* ***** **111**** ********* **********111************* 111111 10000 0001111111100000000 0 000 011111111*********
* ***** **111**** ********* **********111************* 111111 10000 0001111111100000000 0 000 011111111*********
* ***** **111**** ********* **********111************* 111111 10000 0001111111100000000 0 000 011111111*********
________________________________________________________________________________________________________________
...
10:46:39.671 - Noise Lev=1124  Max=1124  VResolution=112 HLen=112
        ---             ---             --- -           ----            ----            ---     ---             
        **111           ***             1** *           1111            1111            000     1111            
        **111           ***             1** *           1111            1111            000     1111            
       ***111       *   *** *       *  11** *           1111            1111            0000   11111            
 *     ***111       *  **** *       * 111** *           1111  1         1111            0000   11111      *     
 *     ***111       *  **** *       * 111** *           1111  1         1111            0000   11111      *     
 * *  ****111  *    ** ****** * *   **111*****     *    11111 10    0   1111  1  00  0  0000   11111  1*  *   * 
**********111 ***  *** ****** *** ****111*****  *******11111111000 000 111111110 00 00 0000000011111111* *******
**********111 ***  *** ****** *** ****111*****  *******11111111000 000 111111110 00 00 0000000011111111* *******
**********111 ***  *** ****** *** ****111*****  *******11111111000 000 111111110 00 00 0000000011111111* *******
**********111 ***  *** ****** *** ****111*****  *******11111111000 000 111111110 00 00 0000000011111111* *******
________________________________________________________________________________________________________________
...
10:46:42.875 - Noise Lev=805  Max=1138  VResolution=113 HLen=112
           11*                          1*               111 1           1111        0          11 1     ****   
           11*                          1*               111 1           1111        0          11111    ****   
           11*                          1*               111 1           1111        0          11111    ****   
     -    ----                          ---    -    -    --- -           ----    --  -     -   -------   ----   
     *    111*                 *       11**    *    *  1 111 1           1111    00 00     0   1111111   ****   
     *    111*                 *       11**    *    *  1 111 1           1111    00 00     0   1111111   ****   
**  **    111** * *    *  * ** *  *  * 11** ** *    *  1 111111    0     1111  0 00000   0 0 0 1111111  ***** * 
** *******111******* *** ******* *****111** ** ********11111111000000001111111 0000000 0000000 11111111 ********
** *******111******* *** ******* *****111** ** ********11111111000000001111111 0000000 0000000 11111111 ********
** *******111******* *** ******* *****111** ** ********11111111000000001111111 0000000 0000000 11111111 ********
** *******111******* *** ******* *****111** ** ********11111111000000001111111 0000000 0000000 11111111 ********
________________________________________________________________________________________________________________
...
10:46:46.710 - Noise Lev=1296  Max=1296  VResolution=129 HLen=112
          ----                         --              ---             ---                     ---     ---      
          111*                         11              111             111                     111     ***      
          111*                         11              111            0111                     111 1   ***      
          111*                         11              111            0111                     111 1   ***      
      *   111*                  *   * 111              111            0111         0           11111   ****     
      *   111**               ***  ** 111              111            0111      0  0           11111 1 ****   * 
      *   111**               ***  ** 111              111            0111      0  0           11111 1 ****   * 
      * * 111**  *   *      *****  ***111* **** *      1111   1 0   000111   1  0  0 0         11111 11****  ** 
* *  ** * 111*** * ******** **********111********   * *1111 11100 0 0001111111 000000000  00 0011111111**** *** 
* *  ** * 111*** * ******** **********111********   * *1111 11100 0 0001111111 000000000  00 0011111111**** *** 
* *  ** * 111*** * ******** **********111********   * *1111 11100 0 0001111111 000000000  00 0011111111**** *** 
________________________________________________________________________________________________________________

10:46:46.710 - OK1 OK RKK=110 6 REGN=*****
10:46:46.710 - OK1rOK RKK=110 6 REGN=*****

__________PROCESSING OK1 CODE__________

10:46:46.750 - Noise Lev=1296  Max=1296  VResolution=129 HLen=112
          ---                         ----             ----            ----                    ----    ----     
          111                         111*             1111            1111                    1111    ****     
          111                         111*            *11111           1111                    1111    ****     
          111                         111*            *11111           1111                    1111    ****     
          111**   *                *  111**           *11111           1111            0       1111    **** *   
         *111**   *                ** 111**           *11111           1111            0       1111    **** *   
         *111**   *                ** 111**           *11111           1111            0       1111    **** *   
  *   *  *111**   *  *    ***      ***111**       *  **11111  1    0  011111  10  0    0    00 111111  ******   
 **** * **111**  *******  ************111****** *******111111 10   00001111111100 0000 00  00001111111 ****** **
 **** * **111**  *******  ************111****** *******111111 10   00001111111100 0000 00  00001111111 ****** **
 **** * **111**  *******  ************111****** *******111111 10   00001111111100 0000 00  00001111111 ****** **
________________________________________________________________________________________________________________
...
Noise Lev=1160  Max=3260  VResolution=326 HLen=112
           |                           |                |               |                       |
     *     |                           |                |               |                       |
     *     |                           |                |               |                       |
     *     |                           ||               |               ||                      |
...
10:19:14.349 - OK1 OK RKK=110 6 REGN=*****
10:19:14.349 - OK1rOK RKK=110 6 REGN=*****

__________PROCESSING OK1 CODE__________

Noise Lev=1096  Max=1080  VResolution=108 HLen=112
    ---   --                          ---              ---             ---                     ---             -
    ***   |||                         |||              |||             |||                     |||             *
    ***   |||                         |||              |||             |||                     |||             *
    ****  ||| *      *                |||              ||||     |      |||  |   |              ||| |   **   *  *
...
Noise Lev=900  Max=805  VResolution=80 HLen=112
         *|||                         |||* *           |||   ||        |||                     |||         *   *
         *|||                         |||* *           |||   ||        |||                     |||         *   *
       * *|||*                        |||* *           ||||  ||        ||| |             | |   ||| |       *   *
       * *|||*                        |||* *           ||||  ||        ||| |             | |   ||| |       *   *
...
10:19:20.539 - OK1 OK RKK=110 6 REGN=*****
10:19:20.539 - OK1rOK RKK=110 6 REGN=*****


__________PROCESSING OK1 CODE__________

Noise Lev=791  Max=1018  VResolution=101 HLen=112
    ***   |||*                        |||              |||             ||                     ||||             *
    ***   |||*                        |||              |||             ||                     ||||             *
    ***   |||*                        |||              |||             ||                     ||||             *
-  ---- ------      -          ---   ----- --          ----           -----  -  - --          ------   -      --
...
10:19:36.197 - Noise level = 01845 - Max sig 06152  Delta 00615
__________PROCESSING OK1 CODE__________

Noise Lev=1845  Max=805  VResolution=80 HLen=112
*         |||** *                    *|||****    *     ||||| |         |||||                   |||||           *
*         |||** *                    *|||****    *     ||||| |         |||||                   |||||           *
*        *|||** * *    |             *|||****    *     ||||| |  |      |||||                  ||||||           *
*        *|||** * *    |             *|||****    *     ||||| |  |      |||||                  ||||||           *
...
10:19:36.262 - Noise level = 01923 - Max sig 06410  Delta 00641
__________PROCESSING OK1 CODE__________

Noise Lev=1923  Max=1138  VResolution=113 HLen=112
          |||**                       |||**           *|||||         | |||||                   |||||           *
         *|||**                       |||**           *|||||         | |||||                   |||||           *
         *|||**                       |||**           *|||||         | |||||                   |||||           *
     *   *|||***                    * |||**    *      *|||||         | |||||                   |||||           *
...
Noise Lev=1632  Max=1018  VResolution=101 HLen=112
    ****  |||*                        |||*             |||||           ||||                    |||| |          *
    ****  |||*                        |||*             |||||           ||||                    |||| |          *
    ****  |||*                        |||*             |||||           ||||                    |||| |          *
    ***** |||* *    *            * *  |||***           |||||      |    |||| |                  |||||| |    *   *
...
10:19:36.396 - OK1 OK RKK=110 6 REGN=*****
10:19:36.396 - OK1rOK RKK=110 6 REGN=*****
...
Noise Lev=1533  Max=1080  VResolution=108 HLen=112
          |||**                       |||*             ||||            |||||                   ||||            *
          |||**                       |||* *           |||| |          |||||                   ||||            *
          |||**                       |||* *           |||| |          |||||                   ||||            *
       * *|||**                 *     |||***        *  ||||||  |       |||||  |         |      ||||||    *     *
...
Noise Lev=805  Max=1138  VResolution=113 HLen=112
    ****  |||*                        |||*             |||             ||||                    ||| |           *
    ****  |||*                        |||*             ||||            ||||               |    ||| |           *
    ****  |||*                        |||*             ||||            ||||               |    ||| |           *
 -  ----  ------                    - ----             ----            ------             -  - -----       -  --
...
Noise Lev=1674  Max=805  VResolution=80 HLen=112
    ******|||** *          *          |||***           ||||| |         ||||||     |            ||||||          *
    ******|||** *          *          |||***           ||||| |         ||||||     |            ||||||          *
    ******|||** *          *    *     |||*** *         ||||| |         ||||||     |            ||||||   *  *  **
    ******|||** *          *    *     |||*** *         ||||| |         ||||||     |            ||||||   *  *  **
...
Noise Lev=1839  Max=805  VResolution=80 HLen=112
   *******|||***                     *|||*           **|||| |         ||||||  |               |||||||        ***
   *******|||***                     *|||*           **|||| |         ||||||  |               |||||||        ***
   *******|||***                     *|||**   *      **|||| |         ||||||| |               |||||||     *  ***
   *******|||***                     *|||**   *      **|||| |         ||||||| |               |||||||     *  ***
